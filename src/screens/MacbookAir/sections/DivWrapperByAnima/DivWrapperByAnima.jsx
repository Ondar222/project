...
export const DivWrapperByAnima = () => {
  return (
    <section className="flex flex-col w-full max-w-[1140px] items-center gap-[30px] mx-auto py-8 md:py-16 px-4">
      <Card className="w-full bg-transparent border-none">
        <CardContent className="flex flex-col items-center gap-2.5 p-0">
          <h2 className="w-full mt-[-1.00px] [font-family:'Bebas_Neue',Helvetica] font-bold text-white text-[32px] sm:text-[48px] md:text-[64px] text-center tracking-[0] leading-normal">
