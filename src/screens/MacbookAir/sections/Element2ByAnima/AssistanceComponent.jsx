      ...
      <div className="cards-grid">
        ...
        <div className="cards-row second-row">
          ...
          <div className="stacked-cards">
            <Card
              style={{ backgroundColor: featuresData[3].content[0].bgColor }}
              className="assistance-card"
            >
              {featuresData[3].content[0].innerContent}
            </Card>
            <Card
              style={{
                backgroundColor: featuresData[3].content[1].bgColor,
                border: featuresData[3].content[1].border,
              }}
              className="assistance-card"
            >
              {featuresData[3].content[1].innerContent}
            </Card>
          </div>
          <div className="medium-wide-card">
            <Card
              style={{ backgroundColor: featuresData[4].bgColor }}
              className="assistance-card"
            >
        ...
        <div className="cards-row third-row">
          ...
          <div className="wide-card">
            <Card
              style={{ backgroundColor: featuresData[6].bgColor }}
              className="assistance-card"
            >
        ...
        <div className="cards-row fourth-row">
          <div className="medium-card">
            <Card
              style={{
                background: featuresData[7].bgColor,
                border: featuresData[7].border,
              }}
              className="assistance-card"
            >
              {featuresData[7].content}
            </Card>
          </div>
          <div className="medium-card">
            <Card
              style={{
                backgroundColor: featuresData[8].bgColor,
